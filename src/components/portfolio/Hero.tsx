...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-2xl md:max-w-3xl lg:max-w-4xl 2xl:max-w-7xl w-full relative px-6 xl:px-0">
        <motion.p
          initial={{ opacity: 0, y: 12 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="font-mono text-md xl:text-lg  text-primary mb-6 flex items-center gap-2"
        >
        ...
        <motion.h1
          ...
          className="font-serif text-6xl 2xl:text-8xl leading-[1.02] tracking-tight text-foreground max-w-3xl 2xl:max-w-5xl"
        >
          {t.hero.title}{" "}
        ...
        <motion.p
          ...
          className="mt-8 max-w-2xl text-md text-muted-foreground leading-relaxed"
        >
          {t.hero.subtitle}
        </motion.p>
        ...
        {/* <motion.div
          ...
          className="mt-2 flex items-center gap-2 text-md text-muted-foreground font-mono"
        >
      ...
      <motion.div
        ...
        className="hidden sm:flex absolute bottom-[-16px] 2xl:bottom-12 left-1/2 -translate-x-1/2 font-mono text-md uppercase tracking-[0.3em] text-muted-foreground flex-col items-center gap-2"
      >
        {t.hero.scroll}
