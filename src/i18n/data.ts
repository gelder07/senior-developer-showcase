...
export const experiences: ExperienceItem[] = [
  {
    ...
    stack: ["React Native", "Expo", "Native Modules","GraphQL", "AWS Lambda", "PostgreSQL","DynamoDB"],
    group: "companies",
  },
  {
    ...
    stack: ["React","TypeScript", "MySQL", "PHP", "Laravel",  "Redux", "Zustand", "React Native", "Ubuntu", "DigitalOcean"],
    group: "companies",
    logo: logoGbm,
  },
  {
  ...
  },
  {
    ...
    stack: ["React", "Redux", "Tailwind", "Python", "Django Rest Framework", "PostgreSQL"],
    group: "companies",
    logo: logoLafise,
  },

  {
    ...
    stack: ["React", "Next.js", "Responsive Design", "Performance Optimization", "Django Rest Framework", "Python", "Postgress"],
    group: "freelance",
  },
  {
    ...
    stack: ["React", "Next.js", "UI/UX", "Responsive Design", "Web Optimization", "Python", "Django Rest Framework", "Postgress"],
    group: "freelance",
  },
  {
    company: "Ogilvy / Target",
    role: { es: "Sistema Interno RRHH — Freelance", en: "Internal HR System — Freelance" },
    period: "2021",
    description: {
  ...
  },
  {
    ...
    role: { es: "Sistema ERP — Freelance", en: "ERP System — Freelance" },
    period: "2023",
    description: {
